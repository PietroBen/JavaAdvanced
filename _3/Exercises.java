...
public class Exercises {
    ...
    private static void exercise2() {
        ...
        Set<String> uniqueStringsFromList = toSet(list);
        Set<String> uniqueStringsFromSet = toSet(set);

        System.out.println("Unique strings from list: " + uniqueStringsFromList);
        System.out.println("Unique strings from set: " + uniqueStringsFromSet);
    }
