...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        if (ourSet.containsAll(Set.of(1, 5, 2))) {    // ho dovuto modificare questa linea togliendo i duplicati di 1
    ...
    private static void exercise2() {
        ...
        //2a. What will this output? [This output prints the fruit set we added one at a time]
        ...
        //2b. What will this output? [Here we are going to join the list first to the set and then print it]
        System.out.println(fruitsSet);
    }
